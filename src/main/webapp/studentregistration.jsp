...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/studentregistration.css">
            ...
            <form action="StudentRegistration" method="post" id="studentForm" enctype="multipart/form-data">
                <div class="form-grid">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper"><i class="fa-solid fa-id-badge input-icon"></i><input type="text" id="regdno" class="input-field" placeholder="Enter Registration number" required name="regdno"></div>
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <label for="sign-upload" class="file-upload-label" id="sign-upload-label">
                            ...
                            <img id="sign-preview" class="file-preview" alt="Signature Preview">
                        </label>
